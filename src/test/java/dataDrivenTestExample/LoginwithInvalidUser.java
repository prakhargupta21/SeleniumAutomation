...
public class LoginwithInvalidUser {
	...
	public Object[][] sampleTestData() {
		...
		Object[][] data = { { "rahul@gmail.com", "demo@123" }, { "sahil@gmail.com", "password@123" },
				{ "abhishek@gmail.com", "12345" } };
	...
	public Object[][] DatabaseTestData() {
		...
		Object[][] data = { { "rahul1@gmail.com", "demo@123" }, { "sahil1@gmail.com", "password@123" },
				{ "abhishek1@gmail.com", "12345" } };
		// extract data from excel/csv/database/json/xml
		return data;
